...
curl "https://www.googleapis.com/youtube/v3/search?part=snippet&channelId=UCGgeDgjIJ3GXZcLUnExAybw&type=video&order=date&maxResults=100&key=AIzaSyCT6mFtx_a5gqWpvjnSnUS7lDd6wrrLmgI" > Madrestna_Channel.json


curl "https://www.googleapis.com/youtube/v3/search?part=snippet&channelId=UCGgeDgjIJ3GXZcLUnExAybw&type=video&eventType=live&key=AIzaSyCT6mFtx_a5gqWpvjnSnUS7lDd6wrrLmgI" > Madrestna_Channel_Live.json
...
cd C:\Users\medisaapps\Public\Android\EgyptApps\Families
...
curl "https://www.googleapis.com/youtube/v3/search?part=snippet&channelId=UCfZVRPD9O6rlSFnanpNXG4A&type=video&order=date&maxResults=100&key=AIzaSyDVXHy2D-umGU-ExrjJr62tmovs5BBXh44" > Yazan_Family.json
curl "https://www.googleapis.com/youtube/v3/search?part=snippet&channelId=UCqJNTGwKmgMCwfYDbnz514Q&type=video&order=date&maxResults=100&key=AIzaSyDVXHy2D-umGU-ExrjJr62tmovs5BBXh44" > anasala_family.json
...
cd C:\Users\medisaapps\Public\Android\EgyptApps\Madrasati

curl "https://www.googleapis.com/youtube/v3/search?part=snippet&channelId=UCndb1LGM5oQJVhjh2NViU5g&type=video&order=date&maxResults=100&key=AIzaSyCghMwZZstjt92Zx5Mep8V2_aCvvVdkI1A" > DorosIEN.json

curl "https://www.googleapis.com/youtube/v3/search?part=snippet&channelId=UCL-2Lb4n3uiKbmLu9q9KroQ&type=video&order=date&maxResults=100&key=AIzaSyCghMwZZstjt92Zx5Mep8V2_aCvvVdkI1A" > Madrasati.json
